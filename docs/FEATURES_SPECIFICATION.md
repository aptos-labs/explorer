...
| **Tooltip vs. menu** | The hover tooltip is dismissed as soon as the dropdown opens and is non-interactive, so its popper (which paints above the menu) never covers or swallows clicks on the first option. |
