...
function RenderAccountResources({
  ...
  if (error)
    return (
      <RenderError address={address as string} title={title} error={error} />
    );
      ...
      <Grid item xs={12}>
        <SafeRequestComponent
          request={(network: string) =>
            getAccount({address: address as string}, network)
          }
        ...
        <SafeRequestComponent
          request={(network: string) =>
            getAccountResources({address: address as string}, network)
          }
          args={[state.network_value]}
        >
        ...
        <SafeRequestComponent
          request={(network: string) =>
            getAccountModules({address: address as string}, network)
          }
          args={[state.network_value]}
        >
