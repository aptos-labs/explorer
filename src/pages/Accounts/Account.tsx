...
function RenderAccount({ data, error }: { data?: Account, error?: ResponseError }) {
  ...
  return renderSection(
    <>
      ...
      spacing={2}
    >
    <Box component="span" sx={{ whiteSpace: "nowrap", }}>Account</Box>
    <Box component="span" sx={{ fontFamily: theme.typography.fontFamily, fontWeight: theme.typography.fontWeightLight, overflowWrap: "break-word", fontSize: "1.5rem", display: "block", }}>{address}</Box>
  </Stack>
