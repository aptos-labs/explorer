...
const faqStakingData = [
  {
    ...
    answer: (
      <React.Fragment>
        As an MVMT holder, you can 'delegate' your MVMT to a delegation pool.
        The total delegation pool is an aggregation of staked MVMT from various
      ...
      <React.Fragment>
        ...
        <ol style={{marginLeft: "1em"}}>
          <li>
            ...
            that you’d like to stake your MVMTs to.
          </li>
          <li>
