...
import { Link, Box, Table, TableBody, TableCell, TableHead, TableRow, Typography } from '@mui/material';
...
type ProposalRowProps = {
    proposal: Types.OnChainTransaction;
...
type Props = {
    proposals: Types.OnChainTransaction[];
    columns?: ProposalColumn[];
};
