...
export function VoteButtons(){
  ...
  if(voted){
    return (
      <Button variant="primary" disabled>Voted Against</Button>
    )
  }
  ...
  return (
      ...
      <Grid container
        ...
        alignItems="center"
        >
        <Button variant="primary" sx={{mr:2}} onClick={onForVoteClick}>For</Button>
        <Button variant="primary" onClick={onAgainstVoteClick}>Against</Button>
