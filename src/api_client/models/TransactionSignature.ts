...
export function TransactionSignatureFromJSONTyped(
  json: any,
  ...
  return {
    ...
    ...MultiAgentSignatureFromJSONTyped(json, true),
    ...MultiEd25519SignatureFromJSONTyped(json, true),
  };
}

export function TransactionSignatureToJSON(
  ...
  return {
    ...
    ...MultiAgentSignatureToJSON(value),
