...
export function MultiAgentSignatureFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiAgentSignature {
    ...
    return {
        ...
        'secondarySigners': ((json['secondary_signers'] as Array<any> || []).map(AccountSignatureFromJSON)),
    };
}

export function MultiAgentSignatureToJSON(value?: MultiAgentSignature | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'secondary_signers': ((value.secondarySigners as Array<any> || []).map(AccountSignatureToJSON)),
    };
}
