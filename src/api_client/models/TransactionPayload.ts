...
export function TransactionPayloadFromJSONTyped(
  json: any,
  ...
  return {
    ...ModuleBundlePayloadFromJSONTyped(json, true),
    ...ScriptFunctionPayloadFromJSONTyped(json, true),
    ...ScriptPayloadFromJSONTyped(json, true),
    ...WriteSetPayloadFromJSONTyped(json, true),
  };
}

export function TransactionPayloadToJSON(
  ...
  return {
    ...ModuleBundlePayloadToJSON(value),
    ...ScriptFunctionPayloadToJSON(value),
    ...ScriptPayloadToJSON(value),
    ...WriteSetPayloadToJSON(value),
  };
}
