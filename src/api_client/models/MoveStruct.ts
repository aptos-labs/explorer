...
export function MoveStructFromJSONTyped(json: any, ignoreDiscriminator: boolean): MoveStruct {
    ...
    return {
        ...
        'abilities': ((json['abilities'] as Array<any> || []).map(MoveAbilityFromJSON)),
        'genericTypeParams': ((json['generic_type_params'] as Array<any> || []).map(MoveStructGenericTypeParamsFromJSON)),
...
export function MoveStructToJSON(value?: MoveStruct | null): any {
    ...
    return {
        ...
        'generic_type_params': ((value.genericTypeParams as Array<any> || []).map(MoveStructGenericTypeParamsToJSON)),
