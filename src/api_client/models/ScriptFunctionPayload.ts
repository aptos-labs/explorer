...
export function ScriptFunctionPayloadFromJSON(json: any): ScriptFunctionPayload {
    return ScriptFunctionPayloadFromJSONTyped(json, false);
}

export function ScriptFunctionPayloadFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScriptFunctionPayload {
...
export function ScriptFunctionPayloadToJSON(value?: ScriptFunctionPayload | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
