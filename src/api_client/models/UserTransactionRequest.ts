...
export function UserTransactionRequestFromJSON(
  json: any,
): UserTransactionRequest {
  return UserTransactionRequestFromJSONTyped(json, false);
}

export function UserTransactionRequestFromJSONTyped(
  json: any,
...
export function UserTransactionRequestToJSON(
  value?: UserTransactionRequest | null,
): any {
  if (value === undefined) {
    return undefined;
  }
