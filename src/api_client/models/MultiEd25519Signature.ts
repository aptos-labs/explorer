...
export function MultiEd25519SignatureFromJSON(json: any): MultiEd25519Signature {
    return MultiEd25519SignatureFromJSONTyped(json, false);
}

export function MultiEd25519SignatureFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiEd25519Signature {
...
export function MultiEd25519SignatureToJSON(value?: MultiEd25519Signature | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
