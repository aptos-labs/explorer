...
export function BlockMetadataTransactionAllOfFromJSON(
  json: any,
): BlockMetadataTransactionAllOf {
  return BlockMetadataTransactionAllOfFromJSONTyped(json, false);
}

export function BlockMetadataTransactionAllOfFromJSONTyped(
  json: any,
...
export function BlockMetadataTransactionAllOfToJSON(
  value?: BlockMetadataTransactionAllOf | null,
): any {
  if (value === undefined) {
    return undefined;
  }
