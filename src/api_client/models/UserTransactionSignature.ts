...
export function UserTransactionSignatureFromJSON(json: any): UserTransactionSignature {
    return UserTransactionSignatureFromJSONTyped(json, false);
}

export function UserTransactionSignatureFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserTransactionSignature {
...
export function UserTransactionSignatureToJSON(value?: UserTransactionSignature | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
