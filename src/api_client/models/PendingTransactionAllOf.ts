...
export function PendingTransactionAllOfFromJSON(json: any): PendingTransactionAllOf {
    return PendingTransactionAllOfFromJSONTyped(json, false);
}

export function PendingTransactionAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PendingTransactionAllOf {
...
export function PendingTransactionAllOfToJSON(value?: PendingTransactionAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
