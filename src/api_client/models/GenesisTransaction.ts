...
export function GenesisTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenesisTransaction {
...
export function GenesisTransactionToJSON(value?: GenesisTransaction | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
