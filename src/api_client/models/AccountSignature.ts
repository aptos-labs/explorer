...
export function AccountSignatureFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountSignature {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return { ...Ed25519SignatureFromJSONTyped(json, true), ...MultiEd25519SignatureFromJSONTyped(json, true) };
}
...
export function AccountSignatureToJSON(value?: AccountSignature | null): any {
    ...
    return { ...Ed25519SignatureToJSON(value), ...MultiEd25519SignatureToJSON(value) };
}
