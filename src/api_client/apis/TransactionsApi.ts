...
export class TransactionsApi extends runtime.BaseAPI {
     ...
     */
    async createSigningMessageRaw(requestParameters: CreateSigningMessageRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<InlineResponse200>> {
        if (requestParameters.userTransactionRequest === null || requestParameters.userTransactionRequest === undefined) {
            throw new runtime.RequiredError('userTransactionRequest','Required parameter requestParameters.userTransactionRequest was null or undefined when calling createSigningMessage.');
        }
        ...
        const response = await this.request({
            ...
            body: UserTransactionRequestToJSON(requestParameters.userTransactionRequest),
        }, initOverrides);
     ...
     * Create transaction signing message
     */
    async createSigningMessage(requestParameters: CreateSigningMessageRequest, initOverrides?: RequestInit): Promise<InlineResponse200> {
        const response = await this.createSigningMessageRaw(requestParameters, initOverrides);
     ...
     */
    async getAccountTransactionsRaw(requestParameters: GetAccountTransactionsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<OnChainTransaction>>> {
        if (requestParameters.address === null || requestParameters.address === undefined) {
            throw new runtime.RequiredError('address','Required parameter requestParameters.address was null or undefined when calling getAccountTransactions.');
        }
        ...
        const response = await this.request({
            path: `/accounts/{address}/transactions`.replace(`{${"address"}}`, encodeURIComponent(String(requestParameters.address))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Get account transactions
     */
    async getAccountTransactions(requestParameters: GetAccountTransactionsRequest, initOverrides?: RequestInit): Promise<Array<OnChainTransaction>> {
    ...
    async getTransactionRaw(requestParameters: GetTransactionRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Transaction>> {
        if (requestParameters.txnHashOrVersion === null || requestParameters.txnHashOrVersion === undefined) {
            throw new runtime.RequiredError('txnHashOrVersion','Required parameter requestParameters.txnHashOrVersion was null or undefined when calling getTransaction.');
        }
        ...
        const response = await this.request({
            path: `/transactions/{txn_hash_or_version}`.replace(`{${"txn_hash_or_version"}}`, encodeURIComponent(String(requestParameters.txnHashOrVersion))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Get transactions
     */
    async getTransactionsRaw(requestParameters: GetTransactionsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<OnChainTransaction>>> {
        const queryParameters: any = {};
     ...
     * Get transactions
     */
    async getTransactions(requestParameters: GetTransactionsRequest = {}, initOverrides?: RequestInit): Promise<Array<OnChainTransaction>> {
     ...
     * Submit transaction
     */
    async submitTransactionRaw(requestParameters: SubmitTransactionOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<PendingTransaction>> {
        if (requestParameters.submitTransactionRequest === null || requestParameters.submitTransactionRequest === undefined) {
            throw new runtime.RequiredError('submitTransactionRequest','Required parameter requestParameters.submitTransactionRequest was null or undefined when calling submitTransaction.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PendingTransactionFromJSON(jsonValue));
    }
     ...
     * Submit transaction
     */
    async submitTransaction(requestParameters: SubmitTransactionOperationRequest, initOverrides?: RequestInit): Promise<PendingTransaction> {
